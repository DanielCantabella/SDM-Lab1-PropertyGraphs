...
papers = requests.get("http://api.semanticscholar.org/datasets/v1/release/latest/dataset/papers",headers={'x-api-key':'JFgojBji9Y7BmuhrVquD265rHCMX50js9sXwV45G'}).json()
print(papers['files'][0])
